...
import {
  Container, Header, Form, Button, Icon, Dropdown, Image,
...
export default class CreateEstimation extends React.Component {
  ...
  <span>
	...
	onCreateEstimation = () => {
	  ...
	  const members = this.membersToObject(selectedMembers);


	  const tasksToSave = this.tasksToObject(tasks);
	...
	render() {
	  const {
	    selectedTeamId, allMembers, selectedNames, tasks,
	  } = this.state;
	  const { teams } = this.props;
	  return (
  <Container>
...
Tasks to estimate
  ...
  <div className="text-center">
    <h1>
To create estimation meeting you need to have one team at least.
    </h1>
