...
import { Container, Header, List } from 'semantic-ui-react/dist/commonjs';
...
export default class PrivacyPolicy extends PureComponent {
  render() {
    return (
      <Container>
        <p>
          This Privacy Policy governs the manner in which Scrum Helper collects, uses,
          maintains and discloses information collected from users (each, a "User")
          of the https://scrum-helper.ninja/ website ("Site").
        </p>
        ...
        <p>
          Scrum Helper may collect and use Users personal information for the following purposes:
        </p>
        <List bulleted>
          <List.Item>
          ...
          <List.Item>
            ...
            <p>
              Information you provide helps us respond to your customer service requests 
        ...
        <p>This document was last updated on March 27, 2018</p>
      </Container>
    );
  }
}
